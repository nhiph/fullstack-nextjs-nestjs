...
import { ChangePasswordAuthDto, CreateAuthDto, CodeAuthDto } from '@/auth/dto/create-auth.dto';
...
export class UsersService {
  ...
  async handleRegister(registerDto: CreateAuthDto) {
    ...
    //send email, duoc gui song song vs tra ra phan hoi,
  ...
  async handleActive(data: CodeAuthDto) {
    ...
    // 2 cases: 1. userId is not exit, 2. code is expired
    if (!user) {
  ...
  async retryActive(email: string) {
    ...
    //update user expiration active code
